...
- **REFUTE: Reasoning Over Evidence — Falsification, Uncertainty, Truth-grounding & Epistemics** — [![img](https://img.shields.io/badge/Hugging%20Face-REFUTE-yellow)](https://huggingface.co/datasets/BGPT-OFFICIAL/refute) [![img](https://img.shields.io/badge/Leaderboard-REFUTE-blue)](https://huggingface.co/spaces/BGPT-OFFICIAL/refute-leaderboard) — Open benchmark for scientific epistemics on recent paper summaries (falsification, overclaim detection, missing-evidence abstention, Brier-scored calibration; judge-free MCQ axes) — [![img](https://img.shields.io/badge/arXiv-2504.01848-red)](https://arxiv.org/abs/2504.01848) [![img](https://img.shields.io/badge/Web-PaperBench-blue)](https://openai.com/research/paperbench)
