...
- **MRAgent: An LLM‑Based Automated Agent for Causal Knowledge Discovery in Disease via Mendelian Randomization** — BriefBioinf, 2025 · [website](https://pmc.ncbi.nlm.nih.gov/articles/PMC11975362/)
...
- **Verl: Volcano Engine Reinforcement Learning for Large Language Models** — GitHub, 2024 · [code](https://github.com/verl-project/verl)
...
- **SciEval: A Multi-Level Large Language Model Evaluation Benchmark for Scientific Research** — AAAI, 2024 · [paper](https://arxiv.org/abs/2308.13149) · [dataset](https://huggingface.co/datasets/OpenDFM/SciEval)
