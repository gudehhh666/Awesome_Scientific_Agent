...
- **BioMaze: Benchmarking and enhancing large language models for biological pathway reasoning** — [![img](https://img.shields.io/badge/arXiv-2502.16660-b31b1b)](https://arxiv.org/abs/2502.16660) [![img](https://img.shields.io/badge/HF-BioMaze-blue)](https://huggingface.co/datasets/haitengzhao/BioMaze)
- **BiokgBench: A knowledge graph checking benchmark of AI agent for biomedical science** — [![img](https://img.shields.io/badge/arXiv-2024-gray)](https://arxiv.org/abs/2024) [![img](https://img.shields.io/badge/GitHub-BioKGBench-green)](https://github.com/westlake-autolab/BioKGBench)
- **Tomato-Chem: Benchmark for chemistry hypothesis discovery** — [![img](https://img.shields.io/badge/arXiv-missing-gray)]() [![img](https://img.shields.io/badge/GitHub-MOOSE--Chem-green)](https://github.com/ZonglinY/MOOSE-Chem)
- **SurveyBench: On the outline heuristics, memory-driven generation, and multi-dimensional evaluation for automated survey writing** — [![img](https://img.shields.io/badge/arXiv-2503.04629-b31b1b)](https://arxiv.org/abs/2503.04629) [![img](https://img.shields.io/badge/GitHub-SurveyForge-green)](https://github.com/Alpha-Innovator/SurveyForge)
- **MMLU‑Pro: A more robust and challenging multitask language understanding benchmark** — [![img](https://img.shields.io/badge/NeurIPS-2024-4b8bbe)](https://papers.neurips.cc/paper_files/paper/2024/hash/mmlu-pro.html) [![img](https://img.shields.io/badge/HF-MMLU--Pro-blue)](https://huggingface.co/datasets/TIGER-Lab/MMLU-Pro)
- **HLE: Humanity’s Last Exam: A hard benchmark at the frontier of human knowledge** — [![img](https://img.shields.io/badge/arXiv-2501.14249-b31b1b)](https://arxiv.org/abs/2501.14249) [![img](https://img.shields.io/badge/Web-lastexam.ai-blue)](https://lastexam.ai/)
- **ScienceQA: Multimodal science QA benchmark** — [![img](https://img.shields.io/badge/arXiv-2301.06016-b31b1b)](https://arxiv.org/abs/2301.06016) [![img](https://img.shields.io/badge/Web-ScienceQA-blue)](https://scienceqa.github.io/)
- **GPQA: Benchmark for hard science QA with hybrid formats** — [![img](https://img.shields.io/badge/arXiv-2307.09635-b31b1b)](https://arxiv.org/abs/2307.09635) [![img](https://img.shields.io/badge/HF-GPQA-blue)](https://huggingface.co/datasets/Idavidrein/gpqa/)
- **SuperGPQA: Scaling LLM evaluation across 285 graduate disciplines** — [![img](https://img.shields.io/badge/arXiv-2025-gray)](https://arxiv.org/abs/2025) [![img](https://img.shields.io/badge/HF-SuperGPQA-blue)](https://huggingface.co/datasets/m-a-p/SuperGPQA)
- **CiteBench: A benchmark for scientific citation text generation** — [![img](https://img.shields.io/badge/arXiv-2212.09577-b31b1b)](https://arxiv.org/abs/2212.09577) [![img](https://img.shields.io/badge/GitHub-CiteBench-green)](https://github.com/UKPLab/citebench)
- **ALCE: Enabling large language models to generate text with citations** — [![img](https://img.shields.io/badge/arXiv-2305.14627-b31b1b)](https://arxiv.org/abs/2305.14627) [![img](https://img.shields.io/badge/GitHub-ALCE-green)](https://github.com/princeton-nlp/ALCE)
- **Reviewer2: Optimizing review generation through prompt generation** — [![img](https://img.shields.io/badge/arXiv-2402.10886-b31b1b)](https://arxiv.org/abs/2402.10886) [![img](https://img.shields.io/badge/GitHub-Reviewer2-green)](https://github.com/ZhaolinGao/Reviewer2)
- **Scientists' First Exam: Probing cognitive abilities of MLLM via perception, understanding, and reasoning** — [![img](https://img.shields.io/badge/arXiv-2025-gray)](https://arxiv.org/abs/2025) [![img](https://img.shields.io/badge/HF-SFE-blue)](https://huggingface.co/datasets/PrismaX/SFE)
- **MR‑Ben: A comprehensive meta-reasoning benchmark for large language models** — [![img](https://img.shields.io/badge/arXiv-2406.13975-b31b1b)](https://arxiv.org/abs/2406.13975) [![img](https://img.shields.io/badge/Web-MR--Ben-blue)](https://randolph-zeng.github.io/Mr-Ben.github.io/)
- **FigureQA: An annotated figure dataset for visual reasoning** — [![img](https://img.shields.io/badge/arXiv-1710.07300-b31b1b)](https://arxiv.org/abs/1710.07300) [![img](https://img.shields.io/badge/HF-FigureQA-blue)](https://huggingface.co/datasets/vikhyatk/figureqa)
- **SciEval: A multi-level large language model evaluation benchmark for scientific research** — [![img](https://img.shields.io/badge/AAAI-2024-4b8bbe)](https://ojs.aaai.org/index.php/AAAI/article/view/28513) [![img](https://img.shields.io/badge/HF-SciEval-blue)](https://huggingface.co/datasets/OpenDFM/SciEval)
- **MedQA: Benchmark for medical exam-style QA** — [![img](https://img.shields.io/badge/arXiv-2501.18362-b31b1b)](https://arxiv.org/abs/2501.18362) [![img](https://img.shields.io/badge/HF-MedQA-blue)](https://huggingface.co/datasets/bigbio/med_qa)
- **LLM‑SRBench: A new benchmark for scientific equation discovery with large language models** — [![img](https://img.shields.io/badge/arXiv-2504.10415-b31b1b)](https://arxiv.org/abs/2504.10415) [![img](https://img.shields.io/badge/HF-LLM--SRBench-blue)](https://huggingface.co/datasets/nnheui/llm-srbench)
- **GenoTEX: A benchmark for evaluating LLM-based exploration of gene expression data** — [![img](https://img.shields.io/badge/arXiv-2406.15341-b31b1b)](https://arxiv.org/abs/2406.15341) [![img](https://img.shields.io/badge/HF-GenoTEX-blue)](https://huggingface.co/datasets/Liu-Hy/GenoTEX)
- **MLAgentBench: Evaluating language agents on machine learning experimentation** — [![img](https://img.shields.io/badge/arXiv-2310.03302-b31b1b)](https://arxiv.org/abs/2310.03302) [![img](https://img.shields.io/badge/GitHub-MLAgentBench-green)](https://github.com/snap-stanford/MLAgentBench)
- **PaperBench: Evaluating AI's ability to replicate AI research** — [![img](https://img.shields.io/badge/arXiv-2504.01848-b31b1b)](https://arxiv.org/abs/2504.01848) [![img](https://img.shields.io/badge/Web-PaperBench-blue)](https://openai.com/research/paperbench)
- **DS‑Bench: A realistic benchmark for data science code generation** — [![img](https://img.shields.io/badge/arXiv-2505.15621-b31b1b)](https://arxiv.org/abs/2505.15621) [![img](https://img.shields.io/badge/GitHub-DSBench-green)](https://github.com/LiqiangJing/DSBench)
- **DiscoveryWorld: A virtual environment for developing and evaluating automated scientific discovery agents** — [![img](https://img.shields.io/badge/arXiv-2406.06769-b31b1b)](https://arxiv.org/abs/2406.06769) [![img](https://img.shields.io/badge/GitHub-DiscoveryWorld-green)](https://github.com/allenai/discoveryworld)
- **SciCode: A scientist-curated benchmark for scientific code generation** — [![img](https://img.shields.io/badge/arXiv-2407.13168-b31b1b)](https://arxiv.org/abs/2407.13168) [![img](https://img.shields.io/badge/GitHub-SciCode-green)](https://github.com/scicode-bench/SciCode)
- **AgentClinic: A multimodal agent benchmark to evaluate AI in simulated clinical environments** — [![img](https://img.shields.io/badge/arXiv-2024-gray)](https://arxiv.org/abs/2024) [![img](https://img.shields.io/badge/GitHub-AgentClinic-green)](https://github.com/SamuelSchmidgall/AgentClinic)
- **SDRBench: Scientific data reduction benchmark for lossy compressors** — [![img](https://img.shields.io/badge/RIKEN-2021-4b8bbe)](https://riken.jp/research/sdrbench) [![img](https://img.shields.io/badge/Web-SDRBench-blue)](https://sdrbench.github.io/)
