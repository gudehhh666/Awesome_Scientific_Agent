...
- **BioMaze**: **benchmark for complex biological pathway reasoning** — [![img](https://img.shields.io/badge/HF-BioMaze-blue)](https://huggingface.co/datasets/haitengzhao/BioMaze) 
- **BiokgBenchbiomedical knowledge-graph factual checking** — [![img](https://img.shields.io/badge/GitHub-BioKGBench-green)](https://github.com/westlake-autolab/BioKGBench)
- **Tomato-Chem**: **chemistry hypothesis discovery benchmark** — [![img](https://img.shields.io/badge/GitHub-MOOSE--Chem-green)](https://github.com/ZonglinY/MOOSE-Chem) 
- **SurveyBench**: **automated computer science literature survey generation** — [![img](https://img.shields.io/badge/GitHub-SurveyForge-green)](https://github.com/Alpha-Innovator/SurveyForge)
- **MMLU‑Pro**: **professional-level multidisciplinary reasoning QA** — [![img](https://img.shields.io/badge/HF-MMLU--Pro-blue)](https://huggingface.co/datasets/TIGER-Lab/MMLU-Pro)
- **HLE**: **hard science QA challenge dataset** — [![img](https://img.shields.io/badge/Web-lastexam.ai-blue)](https://lastexam.ai/)
- **ScienceQA**: **multimodal science question answering** — [![img](https://img.shields.io/badge/Web-ScienceQA-blue)](https://scienceqa.github.io/)
- **GPQA**: **hard science QA with hybrid ground truth formats** — [![img](https://img.shields.io/badge/HF-GPQA-blue)](https://huggingface.co/datasets/Idavidrein/gpqa/)
- **SuperGPQA**: **scaled benchmark for advanced scientific QA** — [![img](https://img.shields.io/badge/HF-SuperGPQA-blue)](https://huggingface.co/datasets/m-a-p/SuperGPQA)
- **CiteBench**: **scientific citation-text generation evaluation** — [![img](https://img.shields.io/badge/GitHub-CiteBench-green)](https://github.com/UKPLab/citebench)
- **ALCE**: **automated citation generation for writing** — [![img](https://img.shields.io/badge/GitHub-ALCE-green)](https://github.com/princeton-nlp/ALCE)
- **Reviewer2**: **automated scientific peer review generation** — [![img](https://img.shields.io/badge/GitHub-Reviewer2-green)](https://github.com/ZhaolinGao/Reviewer2)
- **Scientists' First Exam**: **multi-domain science knowledge probing** — [![img](https://img.shields.io/badge/HF-SFE-blue)](https://huggingface.co/datasets/PrismaX/SFE)
- **MR‑Ben**: **multiple-choice science reasoning benchmark** — [![img](https://img.shields.io/badge/Web-MR--Ben-blue)](https://randolph-zeng.github.io/Mr-Ben.github.io/)
- **FigureQA**: **figure/chart interpretation QA** — [![img](https://img.shields.io/badge/HF-FigureQA-blue)](https://huggingface.co/datasets/vikhyatk/figureqa)
- **SciEval**: **scientific research QA evaluation set** — [![img](https://img.shields.io/badge/HF-SciEval-blue)](https://huggingface.co/datasets/OpenDFM/SciEval)
- **MedQA**: **medical exam-style question answering** — [![img](https://img.shields.io/badge/HF-MedQA-blue)](https://huggingface.co/datasets/bigbio/med_qa)
- **LLM‑SRBench**: **scientific equation discovery benchmark** — [![img](https://img.shields.io/badge/HF-LLM--SRBench-blue)](https://huggingface.co/datasets/nnheui/llm-srbench)
- **GenoTEX**: **genomic data analysis generation tasks** — [![img](https://img.shields.io/badge/HF-GenoTEX-blue)](https://huggingface.co/datasets/Liu-Hy/GenoTEX)
- **MLAgentBench**: **machine learning experiment implementation tasks** — [![img](https://img.shields.io/badge/GitHub-MLAgentBench-green)](https://github.com/snap-stanford/MLAgentBench)
- **PaperBench**: **scientific paper replication and review** — [![img](https://img.shields.io/badge/Web-PaperBench-blue)](https://openai.com/research/paperbench)
- **DS‑Bench**: **data science analysis task benchmark** — [![img](https://img.shields.io/badge/GitHub-DSBench-green)](https://github.com/LiqiangJing/DSBench)
- **DiscoveryWorld**: **multi-step scientific experiment implementation** — [![img](https://img.shields.io/badge/GitHub-DiscoveryWorld-green)](https://github.com/allenai/discoveryworld)
- **SciCode**: **code generation for scientific workflows** — [![img](https://img.shields.io/badge/GitHub-SciCode-green)](https://github.com/scicode-bench/SciCode)
- **AgentClinic**: **clinical decision evaluation via agents** — [![img](https://img.shields.io/badge/GitHub-AgentClinic-green)](https://github.com/SamuelSchmidgall/AgentClinic)
- **SDRBench**: **scientific data reduction task benchmark** — [![img](https://img.shields.io/badge/Web-SDRBench-blue)](https://sdrbench.github.io/)
